...
class DCN(BaseEstimator, TransformerMixin):
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():
            ...
            复习：
            >>> a=tf.constant([1,2],name='g') # name: A name for the operation (optional).
            >>> print a
            >>> print a
            Tensor("g:0", shape=(2,), dtype=int32)

            a是一个张量（tensor），它是计算节点"g"输出的一个结果
            """
    ...
    # shuffle three lists simutaneously，个人理解这是为了让学习过程更加平稳，避免梯度突然很平或者突然很陡，也算是一个trick。
    ...
    # 这里的predict是train_epoch计算loss的过程
